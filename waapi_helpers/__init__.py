...
def object_get(client:_w.WaapiClient, 
    ...
    if results != None:
        if results["return"] != []:
            ...
            print("WARNING: ", "No such object found - ", obj_get_args["from"], where_name_contains if where_name_contains is not None else '', where_name_matches if where_name_matches is not None else '')
            return retval
